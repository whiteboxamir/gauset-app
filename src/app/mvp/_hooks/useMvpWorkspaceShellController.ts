...
import { mergeWorkspaceSceneGraphIntoSceneDocument } from "@/lib/scene-graph/document.ts";
import type { SceneDocumentV2 } from "@/lib/scene-graph/types.ts";
import { normalizePersistedSceneGraph, serializeSceneDocumentToPersistedSceneGraph } from "@/lib/scene-graph/workspaceAdapter.ts";
...
interface UseMvpWorkspaceShellControllerOptions {
    ...
    sceneGraph: PersistedSceneGraphV1 & { __scene_document_v2?: SceneDocumentV2 };
...
const normalizeSceneGraph = (sceneGraph: any): PersistedSceneGraphV1 & { __scene_document_v2?: SceneDocumentV2 } => {
