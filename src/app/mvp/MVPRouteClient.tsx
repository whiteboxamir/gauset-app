...
import { createEmptyWorkspaceSceneGraph } from "@/lib/mvp-workspace";
...
import { serializeSceneDocumentToPersistedSceneGraph } from "@/lib/scene-graph/workspaceAdapter.ts";
import { createMvpEditorSessionStore } from "@/state/mvpEditorSessionStore.ts";
import { selectRenderableSceneDocument } from "@/state/mvpSceneSelectors.ts";
import type { MvpSceneDraftTransformMap } from "@/state/mvpSceneStore.ts";
...
export default function MVPRouteClient({
    ...
    const sceneStoreRef = useRef(createMvpSceneStore(migrateSceneGraphToSceneDocument(createEmptyWorkspaceSceneGraph())));
                                ...
                                <>
                                    ...
                                    <div className="min-h-0 flex-1 overflow-hidden">
                                        <LeftPanel
                                            ...
                                            onLoadEnvironment={workspace.replaceSceneEnvironment}
                                ...
                                <>
                                    ...
                                    <div className="min-h-0 flex-1 overflow-hidden">
                                        <RightPanel
                                            ...
                                            onDeletePin={workspace.removeScenePin}
                                            onDeleteView={workspace.removeSceneView}
                                            onDuplicateAsset={workspace.duplicateSceneAsset}
                                            onDeleteAsset={workspace.removeSceneAsset}
                                            onAddAsset={workspace.appendSceneAsset}
                                        />
                                    </div>
                                </>
                            )}
