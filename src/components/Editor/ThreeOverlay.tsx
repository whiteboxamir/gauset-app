...
import { isLegacyDegradedSingleImagePreviewMetadata, resolveEnvironmentRenderState } from "@/lib/mvp-product";
import {
    CameraPathFrame,
    CameraPose,
    SpatialPin,
...
export default function ThreeOverlay({
    ...
    const previewProjectionImage = toProxyUrl(environmentRenderState.previewProjectionImage ?? undefined);
